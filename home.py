...
st.set_page_config(
    page_title="Brayan Martinez - Portfolio",
    layout="wide",
...
# Cargamos la API Keu
AIRTABLE_API_KEY = st.secrets["api_key"] # Crea el token en este enlace https://airtable.com/create/tokens


# Seleccionamos el base id de Airtable
AIRTABLE_BASE_ID=st.secrets["id_database"] #Copia la plantilla de este enlace https://airtable.com/appv1dCIP9oXJOXFE/shruOGxFeklRDFp0i/tblIBw5i2w5geQhQc/viwOxM9R5nUpGo3ZO?blocks=hide
